...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference("Airplane.count") do
      post airplanes_url, params: { airplane: { iata_code: @airplane.iata_code, icao_code: @airplane.icao_code, name: @airplane.name } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { iata_code: @airplane.iata_code, icao_code: @airplane.icao_code, name: @airplane.name } }
